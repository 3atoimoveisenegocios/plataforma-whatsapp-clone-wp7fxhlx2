routerAdd(
  ...
  (e) => {
    ...
    var expectedToken = $secrets.get('WHATSAPP_API_TOKEN') || $os.getenv('WHATSAPP_API_TOKEN') || ''
    if (!expectedToken) {
    ...
    var remoteJid = cleanNumber.indexOf('@') !== -1 ? cleanNumber : cleanNumber + '@s.whatsapp.net'
